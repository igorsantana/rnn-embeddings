...
#         self.songs           = songs
#         # self.is_doc          = is_doc
#         # self.m2v_songs       = self.songs.m2v.tolist() if not is_glove else self.songs.gm2v.tolist() 
#         # self.sm2v_songs      = self.songs.sm2v.tolist() if not is_glove else self.songs.gsm2v.tolist() 
